...
func (self ResizeVolumesOutput) GetRetCode() int {
	return IntValue(self.RetCode)
}

func (self Volume) GetCreateTime() time.Time {
	return TimeValue(self.CreateTime)
}
func (self Volume) GetDescription() string {
	return StringValue(self.Description)
}
func (self Volume) GetDevice() string {
	return StringValue(self.Device)
}
func (self Volume) GetInstance() Instance {
	return InstanceValue(self.Instance)
}
func (self Volume) GetInstances() []Instance {
	return InstanceValueSlice(self.Instances)
}
func (self Volume) GetLatestSnapshotTime() time.Time {
	return TimeValue(self.LatestSnapshotTime)
}
func (self Volume) GetOwner() string {
	return StringValue(self.Owner)
}
func (self Volume) GetPlaceGroupID() string {
	return StringValue(self.PlaceGroupID)
}
func (self Volume) GetRepl() string {
	return StringValue(self.Repl)
}
func (self Volume) GetSize() int {
	return IntValue(self.Size)
}
func (self Volume) GetVolumeStatus() string {
	return StringValue(self.Status)
}
func (self Volume) GetStatusTime() time.Time {
	return TimeValue(self.StatusTime)
}
func (self Volume) GetTransitionStatus() string {
	return StringValue(self.TransitionStatus)
}
func (self Volume) GetVolumeID() string {
	return StringValue(self.VolumeID)
}
func (self Volume) GetVolumeName() string {
	return StringValue(self.VolumeName)
}
func (self Volume) GetZoneID() string {
	return StringValue(self.ZoneID)
}
func (self Volume) GetSubCode() int {
	return IntValue(self.SubCode)
}
func (self Volume) GetVolumeType() int {
	return IntValue(self.VolumeType)
}
func (self Volume) GetVolumeTags() []Tag {
